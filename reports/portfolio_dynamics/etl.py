...
# Вторая дата из "Позиция за период [01.01.2026] - [01.09.2026] - SECURITIES"
# — и в имени файла, и в первой строке самого листа.
PERIOD_DATES_PATTERN = re.compile(r"\[(\d{2}\.\d{2}\.\d{4})\]\s*-\s*\[(\d{2}\.\d{2}\.\d{4})\]")
